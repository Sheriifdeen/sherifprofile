...
var demoSlider_2 = Sliderman.slider({
    ...
    width: document.getElementById('slider_container_2').offsetWidth,
    height: document.getElementById('slider_container_2').offsetWidth * 0.64,
    effects: 'rain,stairs,fade',
    display: { autoplay: 3000 }
});

window.addEventListener('resize', function() {
    demoSlider_2.options.width = document.getElementById('slider_container_2').offsetWidth;
    demoSlider_2.options.height = demoSlider_2.options.width * 0.64;
    demoSlider_2.update();
});
